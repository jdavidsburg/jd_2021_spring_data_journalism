...
```{r}
#Louisiana had the highest number of COVID-19 cases per 1,000 people on August 30, 2020

covid_cases_per_thousand <- state_covid_population %>%
  mutate(cases_per_1000 = total_cases/population*1000) %>%
  arrange(desc(cases_per_1000))


# Hawaii had the lowest number of COVID-19 deaths per 1,000 people on August 30, 2020.

covid_deaths_per_thousand <- state_covid_population %>%
  mutate(deaths_per_1000 = total_deaths/population * 1000) %>%
  arrange(deaths_per_1000)
