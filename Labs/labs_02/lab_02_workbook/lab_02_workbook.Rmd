...
arcos_wv_baltimorecity_trimmed <- arcos_md_baltimorecity %>%
  select(buyer_dea_no, buyer_name, buyer_city, total_dosage_unit, total_records)
...
arcos_wv_baltimorecity_sorted<- arcos_wv_baltimorecity_trimmed %>%
  arrange(desc(total_dosage_unit))
...
```{r}
# Answer to question 1: Giant Pharmacy 166 got 10,365 shipments 
...
```{r}
# Answer to question 2: Dr. Alan E Oshinnsky got four pills.  	
arcos_md_baltimorecity_trimmed_sorted <- 
  arcos_md_baltimorecity %>%
