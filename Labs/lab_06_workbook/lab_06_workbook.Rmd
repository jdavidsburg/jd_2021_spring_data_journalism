...
embed_url("https://youtu.be/uZXIPLQ7wb4")
...
most_pills_per_person <- county_pills_population %>%
  ...
  mutate(pills_per_person = population/average_pills_per_year)%>%
  # add a line here to sort the new column from highest to lowest
  arrange(desc(pills_per_person))

most_pills_per_person

# Put the answer here: Schleicher, County in Texas had the highest number of pills shipped to the county per person, at 159.8 pills per person.
```
...
# Video b
# Click play to run the codeblock and the video will display in the markdown document. 
embed_url("https://youtu.be/vk9N4jkZRQM")
...
# Video c
# Click play to run the codeblock and the video will display in the markdown document. 
embed_url("https://youtu.be/YjcgraKC8Ik")
...
# Video d
# Click play to run the codeblock and the video will display in the markdown document. 
embed_url("https://youtu.be/X3iEjssEBys")
...
# Video d
# Click play to run the codeblock and the video will display in the markdown document. 
embed_url("https://youtu.be/Yg-pNqzDuN4")
